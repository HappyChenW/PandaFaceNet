...
# from linimport trunc_normal_, create_classifier, Linear
# from nets.linear import Linear
# from nets.classifier import create_classifier
...
#         'first_conv': 'Conhev2d_1a_3x3.conv', 'classifier': 'fc',
#         **kwargs
#     }
...
class InceptionV3(nn.Module):
    ...
    def __init__(self, num_classes=1000, in_chans=3, drop_rate=0., global_pool='avg', aux_logits=False):
        ...
        # self.conv2d_7b = nn.Conv2d(192, 288, kernel_size=1, stride=1)
        # self.conv2d_8b=nn.Conv2d(288,788,kernel_size=1,stride=1)
        # self.conv2d_9b=nn.Conv2d(788,2048,kernel_size=1, stride=1)
        # self.avgpool_1a = nn.AvgPool2d(8, count_include_pad=False)
        # self.classif = nn.Linear(1536, num_classes)
