...
#         # print(image_indexes, "hshshshshsh")
#         # print(image_indexes[0])
#         # print(selected_path[image_indexes[0]]+'')
...
# with open("D:/chen/facenet-pytorch-main/test.txt") as file:
#     lines_test=file.readlines()
# num_val=int(len(lines_test))
# # num_train=int(len(lines))
# # print(num_val)
# val_dataset     = FacenetDataset(input_shape, lines_test[:], num_val,2)
# gen_val         = DataLoader(val_dataset, batch_size=2, num_workers=0, pin_memory=True,
